...
class TabletForum extends StatefulWidget {
  final double width;
  const TabletForum({Key? key, this.width = 0.0}) : super(key: key);

  @override
  State<TabletForum> createState() => _TabletForumState();
}

class _TabletForumState extends State<TabletForum> {
